...
// Ambil data properti berdasarkan username
...
<div class="body-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ltn__breadcrumb-inner">
                        <h1 class="page-title" style="color: white;">Properti Saya</h1>
                        <div class="ltn__breadcrumb-list">
                            <ul>
                                ...
                                <li style="color: white;">Properti Saya</li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <!-- MY PROPERTIES AREA START -->
    <div class="liton__wishlist-area pb-70">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="mb-30">My Properties</h4>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Tersedia Mulai</th>
                                ...
                                <?php while ($row = $result->fetch_assoc()) { ?>
                                    <tr>
                                        <td class="ltn__my-properties-img">
                                            <a href="#">
                                                <img src="<?php echo htmlspecialchars($row['foto_properti']); ?>" alt="Property Image" width="100">
                                            </a>
                                        </td>
                                        <td>
                                            <div class="ltn__my-properties-info">
                                                <h6><a href="#"><?php echo htmlspecialchars($row['nama']); ?></a></h6>
                                                <small><i class="icon-placeholder"></i> <?php echo htmlspecialchars($row['alamat']); ?></small>
                                            </div>
                                        </td>
                                        <td>
                                            <?php echo htmlspecialchars($row['tersedia_mulai']); ?>
                                        </td>
                                        <td>
                                            <a href="edit.php?id=<?= $row['id'] ?>">Edit</a>
                                        </td>
                                        <td>
                                            <a href="hapus.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Yakin ingin menghapus?');">
