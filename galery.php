        ...
        <div class="ltn__utilize-menu-inner ltn__scrollbar">
            <div class="ltn__utilize-menu-head">
                <div class="site-logo">
                 ...
                 <div class="site-title" style="color: rgb(253, 156, 46); font-size: 16px; font-weight: bold;"> <a href="index-5.html"> PT DIYA PROPERTY UTAMA </a>
                </div>
                <button class="ltn__utilize-close">×</button>
            </div>
            <div class="ltn__utilize-menu">
                <ul>
                    <li><a href="index-5.html">Beranda</a></li>
                    </li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ltn__breadcrumb-inner">
                        <h1 class="page-title" style="color: white;">Galeri</h1>
                        <div class="ltn__breadcrumb-list">
                            <ul>
                                ...
                                <li style="color: white;">Galeri</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="ltn__gallery-active row ltn__gallery-style-2 ltn__gallery-info-hide---">
                ...
                <div class="ltn__gallery-item filter_category_3 col-lg-4 col-sm-6 col-12">
                    <div class="ltn__gallery-item-inner">
                        <div class="ltn__gallery-item-img">
                            <a href="img/gallery/Pwsuite.png" data-rel="lightcase:myCollection">
                                <img src="img/gallery/Pwsuite.png" alt="Image">
                        ...
                        <div class="ltn__gallery-item-info">
                            <h4><a href="https://www.instagram.com/pw.suite/" target="_blank">Pandan Wangi Suite</a></h4>
                            <p>Apartment</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="ltn__gallery-item filter_category_3 col-lg-4 col-sm-6 col-12">
                    <div class="ltn__gallery-item-inner">
                        <div class="ltn__gallery-item-img">
                            <a href="img/gallery/Pwmansion.png" data-rel="lightcase:myCollection">
                                <img src="img/gallery/Pwmansion.png" alt="Image">
                                <span class="ltn__gallery-action-icon">
                                    <i class="fas fa-search"></i>
                                </span>
                            </a>
                        ...
                        <div class="ltn__gallery-item-info">
                            <h4><a href="https://www.instagram.com/diyapropertyutama/" target="_blank">Pandan Wangi Mansion</a></h4>
                            <p>Perumahan</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="ltn__gallery-item filter_category_3 col-lg-4 col-sm-6 col-12">
                    <div class="ltn__gallery-item-inner">
                        <div class="ltn__gallery-item-img">
                            <a href="img/gallery/Greencity.png" data-rel="lightcase:myCollection">
                                <img src="img/gallery/Greencity.png" alt="Image">
                                <span class="ltn__gallery-action-icon">
                                    <i class="fas fa-search"></i>
                                </span>
                            </a>
                        ...
                        <div class="ltn__gallery-item-info">
                            <h4><a href="https://www.instagram.com/perumahannewgreencity/" target="_blank">New Green City</a></h4>
                            <p>Perumahan</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="ltn__gallery-item filter_category_3 col-lg-4 col-sm-6 col-12">
                    <div class="ltn__gallery-item-inner">
                        <div class="ltn__gallery-item-img">
                            <a href="img/gallery/Pwmart1.png" data-rel="lightcase:myCollection">
                                <img src="img/gallery/Pwmart1.png" alt="Image">
                                <span class="ltn__gallery-action-icon">
                                    <i class="fas fa-search"></i>
                                </span>
                            </a>
                        ...
                        <div class="ltn__gallery-item-info">
                            <h4><a href="https://www.instagram.com/pwmart.id/" target="_blank">PW Mart</a></h4>
                            <p>Minimarket</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="ltn__gallery-item filter_category_3 col-lg-4 col-sm-6 col-12">
                    <div class="ltn__gallery-item-inner">
                        <div class="ltn__gallery-item-img">
                            <a href="img/gallery/Pwmart2.png" data-rel="lightcase:myCollection">
                                <img src="img/gallery/Pwmart2.png" alt="Image">
                                <span class="ltn__gallery-action-icon">
                                    <i class="fas fa-search"></i>
                                </span>
                            </a>
                ...
                <!-- gallery-item -->
                 <div class="ltn__gallery-item filter_category_3 col-lg-4 col-sm-6 col-12">
                    <div class="ltn__gallery-item-inner">
                        <div class="ltn__gallery-item-img">
                            <a href="img/gallery/Pwmart3.png" data-rel="lightcase:myCollection">
                                <img src="img/gallery/Pwmart3.png" alt="Image">
                                <span class="ltn__gallery-action-icon">
                                    <i class="fas fa-search"></i>
                                </span>
                            </a>
                ...
                <div class="ltn__gallery-item filter_category_3 col-lg-4 col-sm-6 col-12">
                    <div class="ltn__gallery-item-inner">
                        <div class="ltn__gallery-item-img">
                            <a href="img/gallery/Pwcafe1.png" data-rel="lightcase:myCollection">
                                <img src="img/gallery/Pwcafe1.png" alt="Image">
                                <span class="ltn__gallery-action-icon">
                                    <i class="fas fa-search"></i>
                                </span>
                            </a>
                        ...
                        <div class="ltn__gallery-item-info">
                            <h4><a href="https://www.instagram.com/pw.cafenresto/" target="_blank">PW Cafe & Resto</a></h4>
                            <p>Cafe & Resto</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="ltn__gallery-item filter_category_3 col-lg-4 col-sm-6 col-12">
                    <div class="ltn__gallery-item-inner">
                        <div class="ltn__gallery-item-img">
                            <a href="img/gallery/Pwcafe2.png" data-rel="lightcase:myCollection">
                                <img src="img/gallery/Pwcafe2.png" alt="Image">
                                <span class="ltn__gallery-action-icon">
                                    <i class="fas fa-search"></i>
                                </span>
                            </a>
                ...
                <div class="ltn__gallery-item filter_category_3 col-lg-4 col-sm-6 col-12">
                    <div class="ltn__gallery-item-inner">
                        <div class="ltn__gallery-item-img">
                            <a href="img/gallery/Pwcafe3.png" data-rel="lightcase:myCollection">
                                <img src="img/gallery/Pwcafe3.png" alt="Image">
                                <span class="ltn__gallery-action-icon">
                                    <i class="fas fa-search"></i>
                                </span>
                            </a>
