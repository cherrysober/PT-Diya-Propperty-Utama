...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Disarankan: gunakan password_hash dan password_verify di masa depan
    ...
    if ($user) {
        ...
        $_SESSION['user_id'] = $user['id']; // ✅ ID utama dari tabel users
...
<div class="body-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ltn__breadcrumb-inner">
                        <h1 class="page-title" style="color: white;">Login Admin</h1>
                        <div class="ltn__breadcrumb-list">
                            <ul>
                                ...
                                <li style="color: white;">Login Admin</li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <!-- LOGIN AREA START -->
    <div class="ltn__login-area pb-65 d-flex justify-content-center align-items-center min-vh-100">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area text-center">
                        <h1 class="section-title">Selamat Datang ADMIN! <br> Silahkan login ke akun anda</h1>
                        <p>Silakan masuk untuk mengakses sistem manajemen properti dan administrasi.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6 mx-auto">
                    <div class="account-login-inner">
                        ...
                        <form method="post" action="#" class="ltn__form-box contact-form-box">
                            ...
                            <!-- Lupa password dipindah ke sini -->
                            <div class="go-to-btn mt-2 text-end">
